...
@NgModule({
  declarations: [
    // VendorMasterComponent, TaxComponent, TaxEditComponent, SubTaxComponent,
    // SubTaxEditComponent, TaxRateComponent, TaxRateEditComponent, 
    CreateVendorComponent,
    // CreateBankComponent, CreateBankbranchComponent, BankEditComponent, CreatePaymodeComponent,
    // PaymodeEditComponent, BankbranchEditComponent, VendorSummaryComponent, 
    VendorEditComponent,
    // ContractorComponent, 
    VendorviewComponent,
    //  ClientComponent, ProductComponent, 
    BranchactivityComponent,
    BranchComponent, BranchEditComponent,
    // ClientEditComponent, ProductEditComponent,
    ...
    VendormodificationComponent, ConfirmnotificationComponent, 
    // ValidationserviceComponent,
     VendorreportComponent,
    // HsnComponent, HsnEditComponent,
     RiskComponent, RiskEditComponent, RiskmodificationComponent, KycComponent, KycEditComponent, KycmodificationComponent, BcpModificationComponent, DuediligenceModificationComponent
  ],
  providers: [
    confirmationservice,
    DatePipe],
  imports: [
    ...
    AtmaRoutingModule,NgxSpinnerModule, PdfViewerModule, FormsModule, ReactiveFormsModule
    // PdfViewerModule
  ],
  entryComponents: []
