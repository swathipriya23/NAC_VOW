...
export class PaymentUpdateComponent implements OnInit {
    ...
    constructor(private fb: FormBuilder,private router:Router,private notification: NotificationService,
      ...
      private toastr: ToastrService, private branchDetailShareService: BranchDetailsShareService) { }
    ngOnInit(): void {
      console.log("ghghgh")
  ...
  getBankbranch(id,query) {
    ...
    branchdetails() {
    //   let data :any= this.branchDetailShareService.payment_particular.value
    //  this.mainbranch=data.supplierbranch_id.id;
    let data = this.branchDetailShareService.payment_particular.value
    ...
    console.log("asas",this.branchPayment.value)
